...
- [UX Design Specification - cost-tracker](#table-of-contents)
  ...
  - [Admin Interface](./admin-interface.md)
    - [Design Principles](./admin-interface.md#design-principles)
    - [Admin Navigation Integration](./admin-interface.md#admin-navigation-integration)
    - [User Management Screen](./admin-interface.md#user-management-screen)
    - [Audit Log Screen](./admin-interface.md#audit-log-screen)
    - [Admin Section Navigation](./admin-interface.md#admin-section-navigation)
    - [Responsive Behavior](./admin-interface.md#responsive-behavior)
  - [Filter Bar and Date Picker](./filter-bar-date-picker.md)
    - [Filter Bar Layout](./filter-bar-date-picker.md#filter-bar-layout)
    - [Search Field](./filter-bar-date-picker.md#search-field)
    - [Date Range Button](./filter-bar-date-picker.md#date-range-button)
    - [Paid By Filter](./filter-bar-date-picker.md#paid-by-filter)
    - [Clear All](./filter-bar-date-picker.md#clear-all)
    - [Date Picker Modal](./filter-bar-date-picker.md#date-picker-modal)
    - [Behaviour Reference](./filter-bar-date-picker.md#behaviour-reference)
    - [Visual Tokens Reference](./filter-bar-date-picker.md#visual-tokens-reference)
